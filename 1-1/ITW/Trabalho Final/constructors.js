    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (favoriteList != null) {
                ...
                filtered.forEach(function (constructor) {
                    $("#favourite_" + constructor.ConstructorId).addClass("fa-heart")
                    $("#favourite_" + constructor.ConstructorId).removeClass("fa-heart-o")
                    $("#favourite_" + constructor.ConstructorId).parent().val("1")
                })
            }
