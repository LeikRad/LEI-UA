...
var vm = function () {
    ...
    //self.baseUri = ko.observable('http://localhost:62595/api/seasons');
    self.updateIcons = function () { checkFavorites() }
    self.displayName = 'Season List';
    ...
    self.selectedYear= ko.observable(1950)
    ...
    self.activate = function (id) {
        ...
        ajaxHelper(composedUri, 'GET').done(function (data) {
            ...
            self.years(self.records().map(a => a.Year))
            //self.SetFavourites();
        });
    };
    //--- Internal functions
...
$(document).ready(function () {
    ...
    $("#yearSelector").change(function () {
        var value = $(this).val()
        $("iframe").attr("src", './seasonDetails.html?year=' + value)
